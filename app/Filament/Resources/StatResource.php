...
class StatResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Grid::make(2)->schema([
                Forms\Components\TextInput::make('value')->label('Angka')->required()->helperText('Contoh: 120 atau 4.9'),
                Forms\Components\TextInput::make('suffix')->label('Akhiran')->helperText('Contoh: + atau /5'),
                Forms\Components\TextInput::make('label_id')->label('Label (ID)')->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\TextColumn::make('value')->label('Angka'),
                Tables\Columns\TextColumn::make('label_id')->label('Label')->searchable(),
